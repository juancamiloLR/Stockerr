...
React (SPA): Renderiza la interfaz, gestiona la navegación entre módulos y consume los endpoints de la API.

## Backend

Node.js + Express: Expone la API REST, aplica las reglas de negocio, gestiona la autenticación y controla los permisos por rol.
